...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "مكتبة روبن هود | كتبك العربية المفضلة" },
      { name: "description", content: "مكتبة روبن هود — آلاف العناوين من الأدب العربي والعالمي، توصيل لكل مصر مع الدفع عند الاستلام." },
      { name: "keywords", content: "مكتبة, كتب, كتب عربية, روبن هود, روايات, أدب, شراء كتب, كتب أونلاين, كتب مصر" },
      { name: "author", content: "مكتبة روبن هود" },
      { name: "robots", content: "index, follow" },
      { name: "theme-color", content: "#1c3d2a" },
      { property: "og:site_name", content: "مكتبة روبن هود" },
